		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comerenstocktrans-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comerenstocktrans-display": {
								"semanticObject": "comerenstocktrans",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.eren.stocktrans",
									"url": sap.ui.require.toUrl("com/eren/stocktrans")
								}
							}
						}
					}
